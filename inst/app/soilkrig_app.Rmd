...
Start here (defaults settings) {data.width=700}
=======================================================================
...
```{r}
h4("3. Wait")
helpText("Depending on the size of the data set, results may take several seconds to appear and refresh.")
```
...
```{r}
shiny::numericInput("print_n", "How many rows to show?", 3)
renderPrint({
...
```{r}
shiny::numericInput("print_n2", "How many elements of each result to show?", 6)
renderPrint({
  result <- GetKrigedSoil(active_df(), var = input$var_id)
